...
export default function ResultsTranscriptsPage() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      ...
      <div style={{
        ...
        <p style={{ maxWidth: '400px', textAlign: 'center', lineHeight: '1.5' }}>
          The <strong>Results & Transcripts</strong> module frontend has been successfully scaffolded. 
